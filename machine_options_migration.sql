...
CREATE TABLE IF NOT EXISTS machine_options (
    ...
    maximum_ballpens_per_transaction INTEGER NOT NULL DEFAULT 5 CHECK (maximum_ballpens_per_transaction BETWEEN minimum_ballpens_per_transaction AND 5),
...
ALTER TABLE machine_options
  ADD COLUMN IF NOT EXISTS maximum_ballpens_per_transaction INTEGER NOT NULL DEFAULT 5;
